...
azure storage blob download $BLOB TIB_dsp_gridserver_6.2.0.tar.gz --account-name $ACCOUNT --sas "$TOKEN"

azure storage blob download $BLOB TIB_gridserver_6.2.0_hotfix07.jar --account-name $ACCOUNT --sas "$TOKEN"
